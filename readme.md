...
Un dépot git public est associé au projet EcoWeb. Pour le cloner en local ou sur un serveur, exécuter la commande : 

`git clone https://github.com/barbotinleane/ecoweb.git`
...
## Configurer l'accès à la base de donnée et les variables d'environnement
...
Effectuer les migrations dans la base de donnée pour créer les différentes tables :
...
Après création de la base de donnée, il est nécessaire de créer un compte d'administrateur qui pourra se connecter au site web et gérer celui-ci. 
