 ...
 */
final class Version20220407143943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson_done DROP learner_id, CHANGE id id VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson_done ADD learner_id INT NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
